App.chat = App.cable.subscriptions.create "ChatChannel",
  ...
  received: (data) ->
    ...
    if parseInt(user) is parseInt(data['sender'])
      if data['image']?
        $("#message_body").append("<div class='row justify-content-end'><div class='col-4 sender'><text class='msg_heading'>" + username + "</text><br>"+ data['message']+ "<center><img class='msg_image' src='" + data['image']+ "'></center></div><div class='col-1'><img class='ic' style='width:50px;height:50px;' src='" + user_img + "'></div></div>")
      else
        $("#message_body").append("<div class='row justify-content-end'><div class='col-4 sender'><text class='msg_heading'>" + username + "</text><br>"+ data['message']+ "<center></div><div class='col-1'><img class='ic' style='width:50px;height:50px;' src='" + user_img + "'></div></div>")
    ...
    if parseInt(user) is parseInt(data['receiver'])
      if data['image']?
        ...
        $("#message_body").append("<div class='row justify-content-start'><div class='col-1'><img src='" + sender_img + "' class='ic' style='width:50px;height:50px;'></div><div class='col-4 receiver'><text class='msg_heading'>" + sendername + "</text><br>" + data['message']+ "</div></div>")
